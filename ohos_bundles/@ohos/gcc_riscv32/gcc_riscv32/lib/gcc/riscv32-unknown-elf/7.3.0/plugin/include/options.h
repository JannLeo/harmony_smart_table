...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1152,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1153,                       /* -mcmodel= */
  OPT_mdiv = 1154,                           /* -mdiv */
  OPT_mexplicit_relocs = 1155,               /* -mexplicit-relocs */
  OPT_mfdiv = 1156,                          /* -mfdiv */
  OPT_mplt = 1157,                           /* -mplt */
  OPT_msave_restore = 1158,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1159,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1160,                  /* -mstrict-align */
  OPT_mtune_ = 1161,                         /* -mtune= */
  OPT_n = 1162,                              /* -n */
  OPT_no_canonical_prefixes = 1163,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1164,              /* -no-integrated-cpp */
  OPT_no_pie = 1165,                         /* -no-pie */
  OPT_nocpp = 1166,                          /* -nocpp */
  OPT_nodefaultlibs = 1167,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1168,                   /* -nostartfiles */
  OPT_nostdinc = 1169,                       /* -nostdinc */
  OPT_nostdinc__ = 1170,                     /* -nostdinc++ */
  OPT_nostdlib = 1171,                       /* -nostdlib */
  OPT_o = 1172,                              /* -o */
  OPT_p = 1173,                              /* -p */
  OPT_pass_exit_codes = 1174,                /* -pass-exit-codes */
  /* OPT_pedantic = 1175, */                 /* -pedantic */
  OPT_pedantic_errors = 1176,                /* -pedantic-errors */
  OPT_pg = 1177,                             /* -pg */
  OPT_pie = 1178,                            /* -pie */
  OPT_pipe = 1179,                           /* -pipe */
  ...
  OPT_quiet = 1191,                          /* -quiet */
  OPT_r = 1192,                              /* -r */
  OPT_remap = 1193,                          /* -remap */
  OPT_s = 1194,                              /* -s */

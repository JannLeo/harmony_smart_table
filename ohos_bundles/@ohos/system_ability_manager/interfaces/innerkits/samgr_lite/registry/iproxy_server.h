 ...
 * @{
 *
 * @brief Provides APIs for registrating and discovering inter-process communication (IPC)
 * capabilities.
 *
 * Based on the Samgr development framework, this module enables you to develop system capabilities
